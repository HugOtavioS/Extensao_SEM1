<header class="bg-white border-b border-gray-200 shadow-sm">
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <!-- Mobile menu button -->
            <div class="md:hidden">
                <button type="button" onclick="toggleMobileMenu('navMenuAdm')" class="inline-flex items-center justify-center p-2 rounded-md text-[#333F48] hover:text-[#FF6B35] hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#FF6B35]">
            ...
            <div class="hidden md:flex space-x-4">
                <a href="/" class="bg-[#2EC4B6] text-white px-3 py-2 rounded-md text-sm font-medium hover:bg-[#20AEA1] transition-colors">Admin</a>
    ...
    <div id="navMenuAdm" class="hidden md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t">
            <a href="/" class="block text-white bg-[#2EC4B6] hover:bg-[#20AEA1] px-3 py-2 rounded-md text-base font-medium transition-colors">Admin</a>
