<header class="bg-white border-b border-gray-200 shadow-sm">
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <!-- Mobile menu button -->
            <div class="md:hidden">
                <button type="button" onclick="toggleMobileMenu('navMenu')" class="inline-flex items-center justify-center p-2 rounded-md text-[#333F48] hover:text-[#22c55e] hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-[#22c55e]">
